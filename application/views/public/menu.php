  ...
  <nav class="navbar navbar-default">
    <div class="container-fluid">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Prime Developer</a> </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li><a href="<?= base_url('index.php/user/dynamic');?>">dynamic</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
          <li><a href="<?= base_url('index.php/user/signuppage');?>"><span class="glyphicon glyphicon-user"></span> Sign Up</a> </li>
