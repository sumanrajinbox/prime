...
<header class=" header row ">
  ...
  <div class="col-sm-8 col-xs-4 ">
	  <a href="<?php echo base_url('index.php/admin');?>"><h1 class="hidden-xs">Adminstrator</a><a class="btn-danger btn" href="<?php echo base_url("index.php/test/test");?>">Test</a></h1>
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="<?php echo base_url('index.php/admin/getcpatcha');?>">
      <button class="btn btn-default btn-xs form-control">Login</button>
      </a></li>
    <li><a href="<?php echo base_url('index.php/admin/signuppage');?>">
